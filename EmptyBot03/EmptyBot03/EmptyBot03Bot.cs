...
namespace EmptyBot03
{
    ...
    public class EmptyBot03Bot : IBot
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>                        
        public EmptyBot03Bot()
        {
        }
        ...
        public async Task OnTurnAsync(ITurnContext turnContext, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                await turnContext.SendActivityAsync("Muito prazer Ulysses. Como esta?");
            }

            else if (responseMessage == "Tudo bem")
            {
                await turnContext.SendActivityAsync("Otimo!");
            }
            else if (responseMessage == "Legal")
            {
                await turnContext.SendActivityAsync("Muito mesmo!");
            }

            else
            {
                // Echo back to the user whatever they typed.             
                await turnContext.SendActivityAsync("Tente outra mensagem.", cancellationToken: cancellationToken);
            }
        }
    }
}
